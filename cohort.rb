...
date = Date.new(2017,07,03)
check_date = Date.new(2017,2,2)
beemo = Cohort.new(date)
# beemo.no_lecture_on(14)
 puts beemo.double_check_holiday(check_date).inspect
puts beemo.inspect


# puts beemo.coffee_code_days
